      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto flex-1 flex flex-col gap-6">
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 px-2">Gameplay</h3>
            
            <Toggle 
              label="🎒 Cartoon Mode" 
              description="Fun animated animals that react to answers!"
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 pt-6 space-y-4">
            <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 px-2">Experience</h3>
          ...
          <div className="border-t border-slate-100 dark:border-slate-800 pt-6 space-y-4">
            <h3 className="text-lg font-semibold text-slate-800 dark:text-slate-200 px-2">Display</h3>
